...
proc bodies { } {
	...
	set begin [string first "BCL_MATRIX" $remark_string] 
	while {$begin >= 0} {
	    #extract information from string
	    set end [string first "BCL_VECTOR" $remark_string]
	    set substring [string range $remark_string [expr $begin + 11] [expr $end - 2]]
	    ...
	    set cut [string first "BCL_BODY" $remark_string]
